...
namespace UserManagement
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            builder.RegisterType<UserRepository>().As<IRepository<UserModel>>().SingleInstance();
            builder.RegisterType<UserRepository>().As<ISearchUsers>().SingleInstance();
            builder.RegisterType<UserRepository>().As<IUpdateUsers>().SingleInstance();
